...
import { Bot, FileVideo, Globe, Target, Settings, Sparkles } from "lucide-react"
...
const buildingSteps: BuildingStep[] = [
  {
    id: "understanding",
    label: "Understanding the instructions",
    icon: <FileVideo className="w-5 h-5" />,
    duration: 1500
  },
  {
    id: "analyzing",
    label: "Analysing the video",
    icon: <Bot className="w-5 h-5" />,
    duration: 1200
  },
  {
    id: "fetching",
    label: "Fetching the targeted website",
    icon: <Globe className="w-5 h-5" />,
    duration: 1000
  },
  {
    id: "processing",
    label: "Analysing the object",
  ...
  {
    id: "building",
    label: "Building up the interaction platform",
    icon: <Sparkles className="w-5 h-5" />,
    duration: 1200
  }
]

interface AgentBuildingOverlayProps {
  onComplete: () => void
}

export function AgentBuildingOverlay({ onComplete }: AgentBuildingOverlayProps) {
  ...
  useEffect(() => {
    ...
    const stepDuration = totalDuration / buildingSteps.length
        ...
        <CardContent className="p-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-xs text-muted-foreground">
              <span>Step {currentStep + 1} of {buildingSteps.length}</span>
